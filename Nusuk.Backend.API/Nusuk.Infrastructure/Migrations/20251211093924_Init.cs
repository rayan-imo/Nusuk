        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Gendre = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServiceDetail_Packages_PackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TripPackages_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TripPackages_Trips_TripId",
                        column: x => x.TripId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UsersService_Service_ServiceId",
                        column: x => x.ServiceId,
                        principalTable: "Service",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UsersService_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TripPackageId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    UpdatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Caravans_TripPackageId",
                table: "Caravans",
                column: "TripPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_ServiceDetail_PackageId",
                table: "ServiceDetail",
                column: "PackageId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TripPackages_PackageId",
                table: "TripPackages",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_TripPackages_TripId",
                table: "TripPackages",
                column: "TripId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsersService_ServiceId",
                table: "UsersService",
                column: "ServiceId");

            migrationBuilder.CreateIndex(
                name: "IX_UsersService_UserId",
                table: "UsersService",
                column: "UserId");
        }
